(function (root) {
  ...
  // 一括更新の書き戻し(PUT /k/v1/records.json)を100件ずつに分割し、
  // revision競合(409)が起きたレコードをスキップして次へ進めるためのロジック
  // (age_grade_field_update/related_record_summaryの実装を移植、名前空間・文言のみ変更)。
  //
  // 注意: PUT /k/v1/records.jsonは「1件でも失敗するとリクエスト全体が
  ...
  if (typeof module !== 'undefined' && module.exports) {
    ...
    root.BulkFieldUpdate.BatchWriter = BatchWriter;
  }
